...
var file_syncano_codebox_lb_v1_runner_proto_rawDesc = []byte{
	...
	,
...
var file_syncano_codebox_lb_v1_runner_proto_goTypes = []interface{}{
	...
	(*v1.DeleteRequest)(nil),  // 4: syncano.codebox.script.v1.DeleteRequest
	(*v1.RunResponse)(nil),    // 5: syncano.codebox.script.v1.RunResponse
	(*v1.DeleteResponse)(nil), // 6: syncano.codebox.script.v1.DeleteResponse
}
var file_syncano_codebox_lb_v1_runner_proto_depIdxs = []int32{
	...
	4, // 4: syncano.codebox.lb.v1.ScriptRunner.Delete:input_type -> syncano.codebox.script.v1.DeleteRequest
	5, // 5: syncano.codebox.lb.v1.ScriptRunner.Run:output_type -> syncano.codebox.script.v1.RunResponse
	6, // 6: syncano.codebox.lb.v1.ScriptRunner.Delete:output_type -> syncano.codebox.script.v1.DeleteResponse
...
func (c *scriptRunnerClient) Delete(ctx context.Context, in *v1.DeleteRequest, opts ...grpc.CallOption) (*v1.DeleteResponse, error) {
	out := new(v1.DeleteResponse)
	err := c.cc.Invoke(ctx, "/syncano.codebox.lb.v1.ScriptRunner/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedScriptRunnerServer) Delete(context.Context, *v1.DeleteRequest) (*v1.DeleteResponse, error) {
...
func _ScriptRunner_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/syncano.codebox.lb.v1.ScriptRunner/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ScriptRunnerServer).Delete(ctx, req.(*v1.DeleteRequest))
	}
