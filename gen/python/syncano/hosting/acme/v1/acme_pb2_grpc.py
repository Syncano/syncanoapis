...
class AcmeHostStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Create = channel.unary_unary(
                '/syncano.hosting.acme.v1.AcmeHost/Create',
        ...
        self.Delete = channel.unary_unary(
                '/syncano.hosting.acme.v1.AcmeHost/Delete',
        ...
        self.Refresh = channel.unary_unary(
                '/syncano.hosting.acme.v1.AcmeHost/Refresh',
        ...
        self.List = channel.unary_unary(
                '/syncano.hosting.acme.v1.AcmeHost/List',
...
def add_AcmeHostServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'syncano.hosting.acme.v1.AcmeHost', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))


 # This class is part of an EXPERIMENTAL API.
class AcmeHost(object):
    """Missing associated documentation comment in .proto file"""
    ...
    def Create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/syncano.hosting.acme.v1.AcmeHost/Create',
    ...
    def Delete(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/syncano.hosting.acme.v1.AcmeHost/Delete',
    ...
    def Refresh(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/syncano.hosting.acme.v1.AcmeHost/Refresh',
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/syncano.hosting.acme.v1.AcmeHost/List',
